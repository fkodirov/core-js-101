...
function timeSpanToString(startDate, endDate) {
  ...
  return `${String(endDate.getHours() - startDate.getHours()).padStart(2, 0)}:${String(endDate.getMinutes() - startDate.getMinutes()).padStart(2, 0)}:${String(endDate.getSeconds() - startDate.getSeconds()).padStart(2, 0)}.${String(endDate.getMilliseconds() - startDate.getMilliseconds()).padStart(3, 0)}`;
}
